...
class MarqueeTextView @JvmOverloads constructor(
    ...
    private var isAlwaysScroll = false
    ...
    init {
        ...
        mTextSize =
            ta.getDimensionPixelSize(R.styleable.MarqueeTextView_mtv_textSize, mTextSize.toInt())
                .toFloat()
        ...
        isAlwaysScroll =
            ta.getBoolean(R.styleable.MarqueeTextView_mtv_isAlways_scroll, isAlwaysScroll)
        mEnableFadeEdge =
            ta.getBoolean(R.styleable.MarqueeTextView_mtv_enableFadeEdge, mEnableFadeEdge)
    ...
    private fun innerScroll() {
        ...
        val alwaysDistance = if (!isAlwaysScroll){
            (textWidth - measuredWidth)
        }else{
            measuredWidth.toFloat()
        }

        val distance = if (mLoop && !isAlwaysScroll) (textWidth) else alwaysDistance
//        val firstDistance = if (!isAlwaysScroll){
//            0
//        }else{
//            -measuredWidth
//        }
