...
import com.yichen.androidktx.core.createDrawable
import com.yichen.androidktx.core.dp
import com.yichen.androidktx.core.drawable
...
open class ShapeRelativeLayout @JvmOverloads constructor(context: Context, attributeSet: AttributeSet? = null, defStyleAttr: Int = 0)
    ...
    init {
        ...
        mShadowSize = ta.getDimensionPixelSize(R.styleable.ShapeRelativeLayout_srl_shadowSize, 0)
        mBgDrawable = ta.getDrawable(R.styleable.ShapeRelativeLayout_srl_background)
        ta.recycle()
        applySelf()
    }
